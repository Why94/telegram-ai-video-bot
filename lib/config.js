...
const PROVIDERS = {
  ...
  runninghub: {
    ...
    defaultModel: "seedance-2.0/text-to-video",
    models: {
      seedance: "seedance-2.0/text-to-video",
      seedanceFast: "seedance-2.0-fast/text-to-video",
      kling: "kling-v2.6-pro-image-to-video",
      grokVideo: "xai/grok-imagine/text-to-video-channel-low-price-v1.5"
    }
  }
};
